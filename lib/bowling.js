...
(function() {
  var Bowling, Frame, Frames, err, _;
  ...
  Frames = (function() {
    ...
    Frames.prototype._manageStrikes = function(index) {
      ...
      if (this.frames[index].isStrike()) {
        ...
        return this._manageSecondStrikeBonus(index);
      }
    };

    Frames.prototype._manageSecondStrikeBonus = function(index) {
      if (this.frames[index].throws[1] === void 0) {
        return;
      }
